      ...
      child: Consumer<ClinicalRecordsVM>(
        builder: (context, vm, child) {
          return Scaffold(
            ...
            body: vm.clinicalRecordsStates == ClinicalRecordsStates.isLoading
                ? const Center(child: CircularProgressIndicator())
                : vm.clinicalRecordsStates == ClinicalRecordsStates.hasError
                    ? Center(
                        child: RetryFetch(
                    ...
                    : vm.clinicalRecordsStates == ClinicalRecordsStates.isEmpty
                        ? Center(
                            child: RetryFetch(
                              errorMessage: "No clinical records found",
                              onPressed: () {
                                vm.initialization(patientId: widget.patientId);
                              },
                            ),
